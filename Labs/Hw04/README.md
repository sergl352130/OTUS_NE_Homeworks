...
##### Update от 17.08.2023 - переработана IP-адресация публичных сетей. Для облегчения траблшутинга в будущих домашних заданиях сделан переход от p2p-подсетей с маской /30 к более "широким" подсетям /24. Принята следующая схема формирования IP-адресов:
###### 1. Нумерация:
+ 111 Москва
+ 112 СПб
+ 114 Чокурдах
...
|SW4   |E1/1	   |10.111.2.114 |255.255.255.252|L3 p2p to SW3 |
|SW4   |E1/3	   |10.111.2.126 |255.255.255.252|L3 p2p to SW5 |
...
|SW5   |E1/1	   |10.111.2.101 |255.255.255.252|L3 p2p to SW2 |
|SW5   |E1/3	   |10.111.2.125 |255.255.255.252|L3 p2p to SW4 |
