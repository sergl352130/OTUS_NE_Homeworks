...
##### Update от 17.08.2023 - переработана IP-адресация публичных сетей. Для облегчения траблшутинга в будущих домашних заданиях сделан переход от p2p-подсетей с маской /30 к более "широким" подсетям /24 и /25. Принята следующая схема формирования IP-адресов:
###### 1. Нумерация:
+ 111 Москва
+ 112 СПб
+ 114 Чокурдах
...
|10.111.4.128/26|10.111.4.0/24 |Чокурдах       |LAN VPC31     |
...
|22.111.0.0/16  |22.0.0.0/8    |Киторн-Москва  |to Moscow     |
|10.33.33.0/24  |10.33.33.0/24 |Ламас          |loopbacks mgmt|
|33.111.0.0/16  |33.0.0.0/8    |Ламас-Москва   |to Moscow     |
|33.22.0.0/16   |33.0.0.0/8    |Ламас-Киторн   |to Kitorn     |
|10.44.44.0/24  |10.44.44.0/24 |Триада         |loopbacks mgmt|
|44.22.0.0/16   |44.0.0.0/8    |Триада-Киторн  |to Kitorn     |
|44.33.0.0/16   |44.0.0.0/8    |Триада-Ламас   |to Lamas      |
|44.112.0.0/16  |44.0.0.0/8    |Триада-СПб     |to SPb        |
|44.114.0.0/16  |44.0.0.0/8    |Триада-Чокурдах|to Chok       |
|44.115.0.0/16  |44.0.0.0/8    |Триада-Лабытнанги|to Lab-gi   |
...
|R18   |E1/1     |44.112.26.218|255.255.255.128|to R26 Triada |
...
|R28   |E1/1     |44.114.25.228|255.255.255.128|to R25 Triada |
|Лабытнанги|
|R27   |Loopback0|10.111.5.27  |255.255.255.255|R27 Mgmt      |
|R27   |E0/0     |10.111.5.129 |255.255.255.128|internal LAN  |
|R27   |E1/0     |44.115.25.27 |255.255.255.128|to R25 Triada |
|Киторн|
...
|R25   |E1/0     |44.115.25.25 |255.255.255.128|to R27 Lab-gi |
|R25   |E1/1     |44.114.25.225|255.255.255.128|to R28 Chok   |
...
|R26   |E1/0     |44.114.26.26 |255.255.255.128|to R28 Chok   |
|R26   |E1/1     |44.112.26.226|255.255.255.128|to R18 SPb    |
...
Учитывая, что выбрана архитектура с L3-коммутаторами SW4/SW5 (Москва) и SW9/SW10 (СПб), и L2-домен, соответственно, заканчивается на этих коммутаторах, в начальную схему лабораторной работы внесены следующие изменения:
...
+ HSRP/VRRP не настраивались, так как при такой схеме распределения L2/L3-доменов необходимость в протоколах резервирования первого перехода отсутствует.
