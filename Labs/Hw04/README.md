...
+ Добавлена связь R14 - R15 для обеспечения целостности Area 0 OSPF и синхронизации по iBGP по кратчайшему пути.
...
+ Удалены связи SW9 - R16 и SW10 - R17, так как с точки зрения маршрутизации они избыточны, а порты маршрутизаторов целесообразно экономить.
+ Добавлена связь R16 - R17 для обеспечения резервирования маршрутов передачи трафика.
